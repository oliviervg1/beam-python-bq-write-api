...
package com.google.beam.bigquery.write;
...
public class WriteToBigQuery extends PTransform<PCollection<Row>, PDone> {
   ...
   */
  public static WriteToBigQuery to(String tableName) {
    return new WriteToBigQuery(tableName);
  }

  public WriteToBigQuery usingWriteAPIAtLeastOnceMethod() {
    method = Write.Method.STORAGE_API_AT_LEAST_ONCE;
    return this;
  }

  public WriteToBigQuery usingWriteAPIExactlyOnceMethod() {
  ...
  public PDone expand(PCollection<Row> input) {
    ...
    input
        .apply("Convert Beam Row to TableRow", MapElements.via(
